...
Student identifiers (Roll No, Name)

Course and semester details

Subject-wise theory and practical scores
...
Performed Univariate Analysis (CGPA distribution, result counts)

Performed Bivariate Analysis (CGPA vs SGPA, semester-wise analysis)
...
CGPA and SGPA show a strong positive correlation.

Academic performance varies across semesters.
